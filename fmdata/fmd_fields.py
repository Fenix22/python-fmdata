...
class String(FMFieldMixin, fields.String):
    def __init__(self, *args, **kwargs):
        ...
        self._validate_fm_types(
            {FMFieldType.Text, FMFieldType.Number, FMFieldType.Date, FMFieldType.DateTime, FMFieldType.Time,
    ...
    def _serialize(self, value: Optional[str], attr, obj, **kwargs):
        ...
        try:
            ...
            elif self._field_type == FMFieldType.DateTime:
    ...
    def _deserialize(self, value: Any, attr, data, **kwargs) -> Optional[str]:
        ...
        # TODO nomi dei file fmclient?
        # TODO model check for date format of client
...
class Bool(FMFieldMixin, fields.Boolean):
    def __init__(
            ...
            *args,
            ...
            falsy: Optional[Set[Any]] = None,
            true_value: Any = 1,
            false_value: Any = 0,
            **kwargs,
    ):
        self._truthy = truthy or default_bool_truthy
        self._falsy = falsy or default_bool_falsy
...
class DateTime(FMFieldMixin, fields.DateTime):
    def __init__(self, *args, **kwargs):
        ...
        self._validate_fm_types({FMFieldType.DateTime, FMFieldType.Text})
    ...
    def _serialize(self, value: Optional[datetime], attr, obj, **kwargs):
        ...
        try:
            if self._field_type == FMFieldType.DateTime:
