...
class FMFieldsSerializationTests(unittest.TestCase):
    ...
    def test_string_with_datetime_fieldtype(self):
        fld = fmd_fields.String(field_type=FMFieldType.DateTime)

        dt_iso = "2024-05-18T06:30:05+03:00"  # Time zone info will be lost on serialize/deserialize
    ...
    def test_string_with_container_fieldtype(self):
        ...
        self.assertEqual(True, fld.dump_only)
    ...
    # ---- DateTime ----
    def test_datetime_with_datetime_fieldtype(self):
        fld = fmd_fields.DateTime(field_type=FMFieldType.DateTime)
    ...
    def _allowed_types_by_class(self):
        return {
            'String': {FMFieldType.Text, FMFieldType.Number, FMFieldType.Date, FMFieldType.DateTime, FMFieldType.Time,
            ...
            'DateTime': {FMFieldType.DateTime, FMFieldType.Text},
